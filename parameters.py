...
prms_planck = Parameters(m500c=np.logspace(10, 15, 101), logk_min=-1.,
                         cosmo=cosmo.Cosmology(default="planck_2019"))

# fiducial parameters for halo mass project
prms_masses = Parameters(m500c=np.logspace(14, 15.5, 100), logk_min=-1.)
prms_masses_planck = Parameters(m500c=np.logspace(14, 15.5, 100), logk_min=-1.,
                                cosmo=cosmo.Cosmology(default="planck_2019"))
